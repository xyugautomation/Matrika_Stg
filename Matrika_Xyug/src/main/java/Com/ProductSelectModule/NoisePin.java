package Com.ProductSelectModule;
...
public class NoisePin {
	...
	@FindBy(xpath = "//h2[normalize-space()='NoisePin']")
	...
	@FindBy(xpath = "//a[normalize-space()='subTest']")
...
//	public WebElement productPrice;
	...
	public void IFrame(WebDriver driver) throws InterruptedException {
		...
		newWindowWait.until(ExpectedConditions.elementToBeClickable(SucessButton)); // Wait until the SuccessButton is
																					// click able..!!
		SucessButton.click();
		Thread.sleep(4000);
